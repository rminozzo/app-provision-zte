                ...
                <form class="w-1/2 mx-auto mt-2" onSubmit={authOnt}>
                    <div class="flex grid gap-2">
                        <div>
                            ...
                            <input class="w-full h-10 px-4 mb-2 text-lg text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" name="slot" value={slot} onChange={e => setSlot(e.target.value)} disabled></input>
                        </div>
                        <div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input class="w-full h-10 px-4 mb-2 text-lg text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" name="vlanTel" onChange={e => setVlanTel(e.target.value)} required></input>
                            </div>
                        </div>
